...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "32", height: "32", href: "/images/2local/logo.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React__default['default'].createElement("image", { width: "205", height: "26", href: isDark ? "/images/2local/LogoTextNewDark.png" : "/images/2local/LogoTextNewWhite.png" })));
};
    ...
    return (React__default['default'].createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntrySub, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
...
var rainbowAnimation$2 = styled.keyframes(templateObject_1$E || (templateObject_1$E = __makeTemplateObject(["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"], ["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"])));
var LinkLabel$1 = styled__default['default'].div(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  color: ", ";\n  transition: color 0.4s;\n  flex-grow: 1;\n"], ["\n  color: ", ";\n  transition: color 0.4s;\n  flex-grow: 1;\n"])), function (_a) {
    var isPushed = _a.isPushed, theme = _a.theme;
    return (isPushed ? theme.colors.textSubtle : "transparent");
});
var MenuEntryHorizontal = styled__default['default'].div(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  font: normal normal bold 20px/24px Swis721 BT;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n  opacity: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  font: normal normal bold 20px/24px Swis721 BT;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n  opacity: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    var secondary = _a.secondary;
    return (secondary ? "0 32px" : "0 16px");
}, function (_a) {
    var secondary = _a.secondary;
    ...
    return (isActive ? "inset 0px -4px 0px #df642b" : "none");
}, function (_a) {
    var isActive = _a.isActive;
    return (isActive ? "none" : "0.5");
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
}, function (_a) {
...
var AccordionHorizontal = function (_a) {
    var label = _a.label, isPushed = _a.isPushed, pushNav = _a.pushNav, _b = _a.initialOpenState, initialOpenState = _b === void 0 ? false : _b, children = _a.children, className = _a.className, href = _a.href;
    var location = reactRouterDom.useLocation();
    var _c = React.useState(initialOpenState), isOpen = _c[0], setIsOpen = _c[1];
    var link = "";
    if (href) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(MenuEntryHorizontal, { onClick: handleClick, isActive: location.pathname.includes(link), className: className },
...
var PanelBodyHorizontal = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, isMobile = _a.isMobile, links = _a.links;
    var location = reactRouterDom.useLocation();
    // Close the menu when a user clicks a link on mobile
    var handleClick = isMobile ? function () { return pushNav(false); } : undefined;
    return (React__default['default'].createElement(Container$5, null, links.map(function (entry) {
        ...
        var calloutClass = entry.calloutClass ? entry.calloutClass : undefined;
        if (entry.items) {
            return (React__default['default'].createElement(AccordionHorizontal, { key: entry.label, isPushed: isPushed, pushNav: pushNav, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass, href: entry.href }, isPushed &&
                entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntryHorizontal, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React__default['default'].createElement(MenuLink, { href: item.href }, item.label))); })));
        }
        return (React__default['default'].createElement(MenuEntryHorizontal, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React__default['default'].createElement(MenuLink, { href: entry.href, onClick: handleClick },
                React__default['default'].createElement(LinkLabel$1, { isPushed: isPushed }, entry.label))));
    })));
};
var templateObject_1$G;

var StyledPanel$1 = styled__default['default'].div(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  top: 0;\n  margin-left: 20px;\n  display: flex;\n  justify-content: space-between;\n  flex-shrink: 0;\n  height: 52px;\n  transition: padding-top 0.2s, width 0.2s;\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n"], ["\n  top: 0;\n  margin-left: 20px;\n  display: flex;\n  justify-content: space-between;\n  flex-shrink: 0;\n  height: 52px;\n  transition: padding-top 0.2s, width 0.2s;\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var isPushed = _a.isPushed;
    return (isPushed ? "initial" : "hidden");
});
var PanelHorizontal = function (props) {
    ...
    return (React__default['default'].createElement(StyledPanel$1, { isPushed: isPushed, showMenu: showMenu },
        React__default['default'].createElement(PanelBodyHorizontal, __assign({}, props))));
};
var templateObject_1$H;
...
var StyledWalletName = styled__default['default'](Text)(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  margin-left: 20px;\n"], ["\n  margin-left: 20px;\n"])));
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(StyledButton$1, { size: "sm", variant: "tertiary", onClick: function () {
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(PanelHorizontal, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }),
...
var templateObject_1$N, templateObject_2$h, templateObject_3$9, templateObject_4$2, templateObject_5$1;
